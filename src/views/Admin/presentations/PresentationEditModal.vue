    ...
    <div class="min-h-full px-4 py-8">
      <div class="mx-auto bg-white shadow-2xl dark:bg-gray-800 rounded-xl max-w-7xl">
        <div class="p-6">
          ...
          <!-- Form -->
          <form @submit.prevent="updatePresentation" class="space-y-6">
...
const emit = defineEmits(['close', 'presentationUpdated'])
...
const updatePresentation = async () => {
    try {
        await PresentationService.updatePresentation(presentation.value.id, presentation.value)
           Swal.fire({
            toast: true,
            position: 'top-end',
            icon: 'success',
